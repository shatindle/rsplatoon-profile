...
router.get('/team/find/user', lookupUser);
router.get('/team/find/teams', lookupTeam);
router.get('/team*', teamPage);
router.post('/team/register', registerPage);
router.post('/team/leave', leavePage);
router.post('/team/delete', deletePage);
